...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ForeSmart — Foresee the Markets, Trade Smarter" },
      ...
      { property: "og:title", content: "ForeSmart — Foresee the Markets" },
      { property: "og:description", content: "AI-driven market intelligence and paper-trading wallet for global markets." },
