            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {([
                  ...
                  ["محاكاة تداول", "Paper trading", true, true],
                  ["محفظة وإدارة أصول", "Portfolio management", true, true],
                  ["مستشار AI متقدم", "Advanced AI advisor", false, true],
                  ["إشارات تداول حصرية", "Exclusive trade signals", false, true],
                  ["تحليل محفظة معمّق", "Deep portfolio analytics", false, true],
