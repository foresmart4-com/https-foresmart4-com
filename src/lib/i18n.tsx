...
const dict = {
  ar: {
    ...
    disclaimerTitle: "إخلاء مسؤولية استثماري",
    disclaimerBody: "جميع المعلومات والنصائح والإشارات والتحليلات المقدمة في هذا التطبيق هي لأغراض تثقيفية ومعلوماتية فقط، ولا تُعدّ توصية أو عرضاً أو استشارة مالية مرخصة. الاستثمار في الأسواق المالية والعملات والمعادن والعملات الرقمية ينطوي على مخاطر عالية وقد يؤدي إلى خسارة كامل رأس المال. أنت وحدك المسؤول عن قراراتك الاستثمارية ونتائجها. لا يتحمل مالك التطبيق أو مزودوه أي مسؤولية قانونية أو مالية عن أي خسائر أو أضرار مباشرة أو غير مباشرة. باستخدامك للتطبيق فإنك تقر بقراءة وفهم وقبول هذا الإخلاء، وتتنازل عن أي حق في مقاضاة المالك بسبب قرارات استثمارية اتخذتها بناءً على المحتوى.",
