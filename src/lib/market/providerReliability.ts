...
const PROVIDER_MAP: Record<string, ProviderReliability> = {
  ...
  commodityprice: {
    ...
    status: "restricted",
    reasonAr: "الاشتراك منتهٍ (HTTP 402) — بيانات النفط والسلع غير متاحة حتى تجديد الاشتراك في commoditypriceapi.com",
    allowedForDecisionEngine: false,
  },
  financialdata: {
...
const MARKET_MAP: Record<string, MarketReliability> = {
  ...
  gold: {
    ...
    reasonAr: "TwelveData 401، CommodityPrice 402، FMP 403 — لا يوجد مزود يُعيد سعر ذهب صحيح حالياً",
    allowedForDecisionEngine: false,
  },
  silver: {
    market: "silver",
    ...
    status: "unavailable",
    primaryProvider: null,
    reasonAr: "نفس قيود الذهب — TwelveData 401، CommodityPrice 402، FMP 403",
    allowedForDecisionEngine: false,
  },
  oil_wti: {
    market: "oil_wti",
    ...
    status: "unavailable",
    primaryProvider: null,
    reasonAr: "CommodityPriceAPI اشتراكه منتهٍ (402) — لا يوجد مزود بديل يُعيد سعراً صحيحاً ≥ $20",
    allowedForDecisionEngine: false,
  },
  oil_brent: {
    market: "oil_brent",
    ...
    status: "unavailable",
    primaryProvider: null,
    reasonAr: "CommodityPriceAPI اشتراكه منتهٍ (402) — لا يوجد مزود بديل يُعيد سعر برنت صحيح",
    allowedForDecisionEngine: false,
  },
  europe: {
    market: "europe",
