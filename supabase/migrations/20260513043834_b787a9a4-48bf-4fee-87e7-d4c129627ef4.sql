...
REVOKE ALL ON FUNCTION public.wallet_apply_order(uuid, numeric, text) FROM public;
GRANT EXECUTE ON FUNCTION public.wallet_apply_order(uuid, numeric, text) TO authenticated, service_role;